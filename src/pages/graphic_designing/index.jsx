  ...
  return (
    <>
      ...
      <Layouts>
        ...
        <Service1 data={{ imgPath: "./assets/refinePixelImages/g2.jpg",imageDir: true, button: true, subTitle: "Graphic Designing", btnText: "View our portfolio​", title: "Crafting Eye-catching Designs to Make Your Brand Stand Out!", paraArray: ["Embark on a journey of visual storytelling with our expert design team, dedicated to crafting captivating designs that elevate your brand above the rest. From striking logos to immersive website graphics, we specialize in creating a visual identity that resonates with your audience and leaves a lasting impression"] }} />
        <Service1 data={{ imgPath: "./assets/refinePixelImages/g3.jpg",imageDir: false, button: true, subTitle: "Graphic Designing", btnText: "View our portfolio​", title: "Creative Publication Graphic Design Solutions", paraArray: ["Immerse your publication in a world of creativity with our bespoke graphic design solutions. From eye-catching layouts to compelling visuals, we tailor our designs to breathe life into your content and engage your readers."] }} />
        <VideoSec />
