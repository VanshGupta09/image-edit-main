  ...
  return (
    <>
      ...
      <Layouts>
        ...
        <Service1 data={{ imageDir: true, imgPath: "./assets/SectionImg.jpg", button: true, subTitle: "Video Editing", btnText: "View our portfolio​", title: "Share Your Business Journey Through 2D Animation", paraArray: ["Our 2D animation service is more than just about creating visually stunning videos; it's about weaving narratives that forge strong connections with your audience. By merging strategic thinking with creativity, we produce animated content that not only grabs attention but also compels viewers to engage and act."]}} />
        <Service1 data={{ imgPath: "./assets/SectionImg.jpg", imageDir: false, button: true, subTitle: "Video Editing", btnText: "View our portfolio​", title: "Leverage Professional 3D Animation to Amplify Your Message", paraArray: ["Have a story itching to be told? Let's give it dimension with 3D animation! Share your vision with us, and our team of skilled animators will breathe life into it, crafting a dynamic video that speaks directly to your audience."] }} />
        ...
        <Service1 data={{ imgPath: "./assets/SectionImg.jpg", imageDir: true, button: true, subTitle: "Video Editing", btnText: "View our portfolio​", title: "Explore Our Services in Motion Graphics Design", paraArray: ["In today's fast-paced digital age, static text often gets lost in the shuffle. To truly make your message stand out, you need to speak the language of visuals. At Weeb Innovation, we understand that motion graphics are the key to captivating your audience's attention and delivering your message effectively. Our team specializes in creating engaging motion graphic videos that simplify complex ideas and concepts, making them more accessible to a broader audience."] }} />
        < VideoSec />
        <Service1 data={{ imgPath: "./assets/SectionImg.jpg", imageDir: true, button: true, subTitle: "Video Editing", btnText: "View our portfolio​", title: "Dynamic Logo Animation Service", paraArray: ["Introducing our Dynamic Logo Animation Service—a cutting-edge solution to elevate your brand's visual identity. At Weeb Innovation, we specialize in crafting captivating animated logos that breathe new life into your brand image.Our team of skilled designers and animators meticulously blend creativity and innovation to deliver logo animations that leave a lasting impression. Whether you're looking to add subtle motion to your existing logo or create a completely custom animated logo from scratch, we've got you covered."] }} />
        <Service1 data={{ imgPath: "./assets/SectionImg.jpg", imageDir: false, button: true, subTitle: "Video Editing", btnText: "View our portfolio​", title: "Top-tier 2D Infographic Video Production: Let Us Bring Your Ideas to Life!", paraArray: ["Experience top-tier 2D Infographic Video Production with Weeb Innovation: Where Your Ideas Come to Life!Our expert team transforms your concepts into engaging and informative 2D infographic videos that captivate your audience. Whether you're simplifying complex data or explaining intricate processes, our videos deliver your message with clarity and style."] }} />
        {/* <div className="ped40"></div> */}
