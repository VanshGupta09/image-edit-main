  ...
  return (
    <>
      ...
      <Layouts>
        ...
        <Service1 data={{ imageDir: true, imgPath: "./assets/video1.jpg", button: true, subTitle: "Video Editing", btnText: "View our portfolio​", title: "Share Your Business Journey Through 2D Animation", paraArray: ["Our 2D animation service is more than just about creating visually stunning videos; it's about weaving narratives that forge strong connections with your audience. By merging strategic thinking with creativity, we produce animated content that not only grabs attention but also compels viewers to engage and act."]}} />
        <Service1 data={{ imgPath: "./assets/video2.jpg", imageDir: false, button: true, subTitle: "Video Editing", btnText: "View our portfolio​", title: "Leverage Professional 3D Animation to Amplify Your Message", paraArray: ["Have a story itching to be told? Let's give it dimension with 3D animation! Share your vision with us, and our team of skilled animators will breathe life into it, crafting a dynamic video that speaks directly to your audience."] }} />
